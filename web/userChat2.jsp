...
<center>
  ...
  <form name="userLogin" action="userLogin2Servlet" method="POST">
    ...
    <table border="0" width="30" cellspacing="8" cellpadding="20">
      ...
      <tr>
        ...
        out.print(email1); %>" data-validator="Enter Your Email" required="true"/></td>

        <td>Send To:</td>
        <td><input type="email" name="user2" value="" data-validator="Where to Send?" required="true" /></td>
      </tr>
      <td>Date & Time:</td>
