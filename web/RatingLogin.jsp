...
<div id="wrapper">
  <form action="rating.jsp"  method="post" action="#" >
    <!-- Navigation -->
                  ...
                  <div class="tab-pane active" id="home">
                    ...
                    <form class="form" action="##" method="post" id="registrationForm">
                      <div class="col-xs-6">
                        ...
                        <input pattern="^[0-9]*$" required="true" rows="4" class="form-control" name="id" id="orderid" placeholder="Give Order ID" title="enter Order ID to rate if any."/>
                      </div>
